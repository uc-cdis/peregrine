...
def app_register_blueprints(app):
    ...
    app.register_blueprint(submission.blueprint, url_prefix=v0+'/submission')
...
def app_register_duplicate_blueprints(app):
    ...
    app.register_blueprint(submission.blueprint, url_prefix='/submission')
...
def db_init(app):
    print('in db_init')
    print(app.config['PSQLGRAPH']['database'])
    print(app.config['PSQLGRAPH']['user'])
